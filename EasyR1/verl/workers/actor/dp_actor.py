            ...
            for mini_batch in mini_batches:
                ...
                for micro_batch in micro_batches:
                    ...
                    pg_loss, pg_metrics = compute_policy_loss(
                        ...
                        entropy_threshold_ratio=self.config.entropy_threshold_ratio,
                        min_consecutive_length=self.config.min_consecutive_length,
                        window_size=self.config.window_size,
                        window_stride=self.config.window_stride,
                        min_consecutive_windows=self.config.min_consecutive_windows,
